...
function createRule(name, meta, defaultOptions, ruleFunctionsMap) {
    return ESLintUtils.RuleCreator((ruleName) => `https://github.com/jonaskello/eslint-plugin-functional/blob/v4.2.2/docs/rules/${ruleName}.md`)({
        name,
        meta,
        defaultOptions,
...
const schema$e = [
    {
        type: "object",
        properties: deepmerge(ignorePatternOptionSchema, ignoreAccessorPatternOptionSchema, ignoreClassOptionSchema, {
...
const schema$a = [
    {
        type: "object",
        properties: deepmerge(allowLocalMutationOptionSchema, ignorePatternOptionSchema, {
            allowInForLoopInit: {
                type: "boolean",
            },
        }),
...
const schema$1 = [
    {
        type: "object",
        properties: deepmerge(allowLocalMutationOptionSchema, ignorePatternOptionSchema, ignoreClassOptionSchema, ignoreInterfaceOptionSchema, {
